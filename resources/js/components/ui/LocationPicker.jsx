...
export default function LocationPicker({
    ...
    const baseInputClasses = variant === 'pill'
        ? "appearance-none bg-transparent border-0 focus:ring-0 text-sm py-1.5 w-32 sm:w-40 pl-8 pr-2 cursor-pointer hover:text-mimos-600 transition-colors text-left truncate"
        : "w-full pl-10 pr-4 py-2 bg-white border border-slate-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-mimos-500/50 focus:border-mimos-500/50 transition cursor-pointer text-left";
        ...
        <div className="relative" ref={containerRef}>
            ...
            >
                ...
                <button
                    ...
                    className={`${baseInputClasses} ${selectedLocation ? 'text-slate-900' : 'text-slate-400'}`}
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className="absolute inset-0 p-4 flex flex-col justify-end">
                                    <h3 className="text-base font-semibold text-white mb-0.5 drop-shadow-md">{loc.name}</h3>

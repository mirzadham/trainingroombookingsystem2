...
1. **Project rules** — Read `AGENTS.md`, `.pi/docs/`, and any contributing guidelines
2. **Planning artifacts** — Check `.pi/prds/`, `.pi/plans/`, `.pi/reviews/`, and legacy `.pi/PRPs/{prds,plans,reports,reviews}/` for context related to this PR

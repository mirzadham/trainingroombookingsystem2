...
Write the full plan document using the template below. Save to `.pi/PRPs/plans/{kebab-case-feature-name}.plan.md`.

Create the directory if it doesn't exist:
```bash
mkdir -p .pi/PRPs/plans
```
...
```
.pi/PRPs/plans/{kebab-case-feature-name}.plan.md
```
...
- **File**: .pi/PRPs/plans/{kebab-case-feature-name}.plan.md
- **Source PRD**: [path or "N/A"]
...
> Next step: Run `/prp-implement .pi/PRPs/plans/{name}.plan.md` to execute this plan.
```

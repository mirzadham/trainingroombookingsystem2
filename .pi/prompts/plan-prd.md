...
| Write `.pi/prds/{name}.prd.md` | Produce an implementation plan — that's `/plan` |
...
**Output path**: `.pi/prds/{kebab-case-name}.prd.md`
...
```
PRD created: .pi/prds/{name}.prd.md
...
Next step: /plan .pi/prds/{name}.prd.md

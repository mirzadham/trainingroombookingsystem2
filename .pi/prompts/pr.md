...
- `.pi/prds/` — PRDs this PR implements a milestone of
- `.pi/plans/` — Plans executed by this PR
- `.pi/PRPs/prds/` — legacy PRP PRDs
- `.pi/PRPs/plans/` — legacy PRP implementation plans
- `.pi/PRPs/reports/` — legacy PRP implementation reports

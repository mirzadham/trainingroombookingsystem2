...
| Phase | Codex | Gemini |
|-------|-------|--------|
| Implementation | `~/.pi/.ccg/prompts/codex/architect.md` | `~/.pi/.ccg/prompts/gemini/frontend.md` |
...
1. **Identify Input Type**:
   - Plan file path (e.g., `.pi/plan/xxx.md`)
...
1. Call Gemini (use `~/.pi/.ccg/prompts/gemini/frontend.md`)
...
1. Call Codex (use `~/.pi/.ccg/prompts/codex/architect.md`)
2. Input: Plan content + retrieved context + target files
3. OUTPUT: `Unified Diff Patch ONLY. Strictly prohibit any actual modifications.`
...
1. **Codex Review** (`run_in_background: true`):
   - ROLE_FILE: `~/.pi/.ccg/prompts/codex/reviewer.md`
...
2. **Gemini Review** (`run_in_background: true`):
   - ROLE_FILE: `~/.pi/.ccg/prompts/gemini/reviewer.md`
   - Input: Changed Diff + target files
